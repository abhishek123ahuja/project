...
<div class="col-md-4 col-md-offset-4">
              ...
              <div class="panel-body">
                <div class="text-center">
                  ...
                  <div class="panel-body">
                    ...
                    <form id="register-form" role="form" autocomplete="off" class="form" method="post" action="check_existence">
    
                      <div class="form-group">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="glyphicon glyphicon-envelope color-blue"></i></span>
                          <input id="email" name="email" placeholder="Email address" class="form-control"  type="email"
                                 pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$" title="Invalid Email Address" required="required">                            
                        </div>
                      </div><br>
                      <div class="form-group">
                        <input name="email" class="btn btn-lg btn-primary btn-block" value="Reset Password" type="submit">
                      </div>
 ...
 <!--*********************************************************************************   -->
<footer class="new_footer_area bg_color" style="position:relative;top: 20%;">
