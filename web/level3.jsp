...
<!--********************************************************************************-->
<section class="sec">
<div class="e" onclick="location.href='python_quiz1.jsp'">
  <input type="radio" id="control_01" name="select" value="1" checked>
  <label for="control_01" style="cursor: pointer;">
    <h2>EASY</h2>
  </label>
</div>
<div class="e" onclick="location.href='python_quiz2.jsp'">
  <input type="radio" id="control_02" name="select" value="2">
  <label for="control_02" style="cursor: pointer;">
    <h2>MEDIUM</h2>
  </label>
</div>
<div class="e" onclick="location.href='python_quiz3.jsp'">
